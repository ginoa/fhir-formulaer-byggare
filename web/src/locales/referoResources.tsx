...
export const getResources = (language: string): Resources => {
  ...
  if (language === "sv-SE") {
    return {
      ...
      selectDefaultPlaceholder: "Välj ett av alternativen",
      errorAfterMaxDate: "Datumet får inte infalla efter maxdatum",
      errorBeforeMinDate: "Datumet får inte infalla innan mindatum",
      ...
      repeatButtonText: "Lägg till",
      confirmDeleteButtonText: "Bekräfta borttagning",
      confirmDeleteCancelButtonText: "Kasta ändringar",
      ...
      validationNotAllowed: "inte tillåtet",
      formRequiredErrorMessage: "Fältet är obligatoriskt",
      ...
      yearmonth_field_invalid: "Ogiltigt värde",
      yearmonth_field_invalid_year: "Ett giltigt värde måste fyllas i",
      yearmonth_field_maxdate: "Senaste valbara år-månad",
      yearmonth_field_mindate: "Tidigaste valbara år-månad",
      yearmonth_field_month_placeholder: "Välj månad",
      yearmonth_field_required: "År och månad måste anges",
      yearmonth_field_year_placeholder: "Välj år",
      adresseKomponent_header: "Vem är mottagaren?",
      adresseKomponent_skjemaSendesTil: "Formuläret skickas till:",
      adresseKomponent_sublabel: "Du måste välje en mottagare innan formuläret kan skickas.",
      ...
      adresseKomponent_velgPoliklinikk: "SVälj polyklinik",
      adresseKomponent_velgTjeneste: "Välj behandlingsplats",
      adresseKomponent_feilmelding: "Du måste välja en mottagare.",
      adresseKomponent_loadError: "Tekniskt fel. Kunde inte hitta mottagare.",
      linkOpensInNewTab: "Öppnas i nytt fönster",
      nextStep: "Nästa",
      previousStep: "Föregående",

      maxCharactersText: "tecken",
      timeError_hours_digits: "Fältet för timmar får endast innehålla två tecken",
      timeError_minutes_digits: "Fältet för minuter får endast innehålla två tecken",
      dateLabel_year: "År",
      dateLabel_month: "Månad",
      microwebstep_navigasjon_avbryt_button: "Abryt",
      microwebstep_navigasjon_neste_button: "Nästa",
      microwebstep_navigasjon_tilbake_button: "Tillbaka",
    };
  }
  return {
